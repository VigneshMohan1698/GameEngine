...
//
//bool SpriteAnimationGroupDefinition::LoadFromXmlElement(const XmlElement& element, RendererD12* renderer)
//{
//	m_renderer = renderer;
...
bool SpriteAnimationGroupDefinition::LoadFromXmlElementDx12(const XmlElement& element, RendererD12* rendererD12)
{
	...
	m_spriteSheet = new  SpriteSheet(spriteSheetDimensions, gridLayout);
